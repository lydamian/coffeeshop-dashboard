...
# How to Prepare Berry Fizz at RU Coffee Bar

A sparkling mixed berry drink, perfect for a refreshing non-caffeinated option

## Berry Fizz Calculator

export const BerryFizzCalculator = () => {
  ...
  return (
    <Card className="my-4">
      <CardHeader>
        <CardTitle>Berry Fizz Recipe Calculator</CardTitle>
      </CardHeader>
      <CardContent>
...
- Mixed berry syrup, soda water, ice

## Steps to Prepare Berry Fizz
...
## Tips for the Perfect Berry Fizz
...
Remember, perfecting your Berry Fizz is a journey. Keep experimenting and refining your technique!
